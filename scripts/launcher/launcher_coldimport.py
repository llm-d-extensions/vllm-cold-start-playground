...
# [cold-import variant] vLLM imports are intentionally NOT done at module
# load, so a forked child does NOT inherit them and must import vLLM fresh.
# This is the naive baseline the warm-import launcher improves upon.
...
def vllm_kickoff(vllm_config: VllmConfig, log_file_path: str):
    ...
    # [cold-import variant] import vLLM here, inside the forked child, so the
    # import cost is paid per-launch instead of once in the launcher.
